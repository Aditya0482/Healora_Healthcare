  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
        <div className="h-28 sm:h-32 bg-gradient-to-r from-teal-700 via-emerald-600 to-teal-800 relative px-6 flex items-end justify-between">
          <div className="absolute right-6 top-4 opacity-15">
            <ShieldCheck className="w-20 h-20 sm:w-24 sm:h-24 text-white" />
          </div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4">
              ...
              <div className="relative self-start">
                ...
                <Link
                  ...
                  className="absolute bottom-0.5 right-0.5 sm:bottom-1 sm:right-1 bg-teal-700 hover:bg-teal-800 text-white p-1.5 rounded-full shadow-md transition"
                  title="Change Avatar"
                >
